...
demographics_cleaned <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/person_17818399/person_17818399_*.csv') %>%
...
cardio_biomarkers <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/measurement_88493709/measurement_88493709_*.csv')

has_ehr_data <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/person_51386490/person_51386490_*.csv')

#This is the V2 HCM diagnoses
hcm_diagnoses <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/condition_11913414/condition_11913414_*.csv')

hf_diagnoses <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/condition_38834007/condition_38834007_*.csv')

t2d_diagnoses <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/condition_99474710/condition_99474710_*.csv')


smoking_observations <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/observation_33805075/observation_33805075_*.csv')

bmi_measurements <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/measurement_35181853/measurement_35181853_*.csv')

dbp_measurements <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/measurement_87770652/measurement_87770652_*.csv')

zip_socioeconomic_observations <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/zip_code_socioeconomic_02655435/zip_code_socioeconomic_02655435_*.csv') %>%
  select(person_id, deprindex_observation_datetime=observation_datetime, deprivation_index)

creatinine_hdl_ldl <- read_bq_export_from_workspace_bucket(' gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/measurement_57227741/measurement_57227741_*.csv')
```
## Transform Data
...
# all_disease_conditions <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/condition_73935620/condition_73935620_*.csv')
...
bucket_basepath <- 'gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/'
...
covfiltered_biomarker_diagnoses_demo3_lst <- map2(biomarker_diagnoses_demo3_lst, names(biomarker_diagnoses_demo3_lst), ~nonNA_checker(.x,.y, c('age','sex_at_birth','bmi','pc1','pc2','pc3','pc4','pc5','dbp', 'deprivation_index', 'eGFR', 'HDL','LDL'))) #For each of the biomarkers in biomarker_names

#Output the total number of unique cases and controls who have at least one of the biomarkers AFTER filtering for 
for (i in seq_along(covfiltered_biomarker_diagnoses_demo3_lst)){
  covfiltered_biomarker_diagnoses_demo3_lst[[i]] <- select(covfiltered_biomarker_diagnoses_demo3_lst[[i]], person_id, hcm_5Y_status)
  }

test_tb <- reduce(covfiltered_biomarker_diagnoses_demo3_lst, bind_rows) %>% distinct()
print(length(unique(test_tb$person_id))) #41595
test_tb2 <- filter(test_tb, hcm_5Y_status==T)
print(length(unique(test_tb2$person_id))) #546 cases
#The nrow of test_tb is 41634 because there are 39 cases who flip flop
...
htwt_measurements <- read_bq_export_from_workspace_bucket('gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/bq_exports/jon126@researchallofus.org/20250306/measurement_23043819/measurement_23043819_*.csv')
...
system('gsutil -m cp -r ~/DATA/ gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/' )
system('gsutil -m cp -r ~/OUTPUT/ gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/')
...
system('gsutil cp gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/hcm_regenie_pheno.tsv ./DATA/')
system('gsutil cp gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/hcm_regenie_cov.tsv ./DATA/')
...
#Reupload
system('gsutil cp DATA/hcm_regenie_pheno_euronly.tsv gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/')
system('gsutil cp DATA/hcm_regenie_cov_euronly.tsv gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/')
```
...
age_sex_dist_eda <- function(bucket_basepath, pheno_filename, cov_filename, output_suffix, output_folder = './'){
  ...
  system('gsutil cp nomatch_* gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/MatchIt/' )
...
system('gsutil -m cp age_sex_matched_glm_* gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/MatchIt/' )
system('gsutil -m cp -r ./euronly/ gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/MatchIt/' )
```
...
age_sexmatched_filewriter <- function(index_choice, input_list, regenie_pheno, regenie_covar, output_suffix){
  ...
  system(str_c('gsutil cp', output_phenoname, output_covname, 'gs://fc-secure-1e7ad4a9-ae59-4c79-845f-64924aebf907/PP/DATA/', sep =' '))
