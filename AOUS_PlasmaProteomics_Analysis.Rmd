...
#For their age, I take their age at the cutoff of the most recent CDR i.e V7 = 07/01/22 July 1 2022
...
system('gsutil cp gs://fc-secure-7953e92c-a6a6-42df-9f19-86d553a9044f/PP/DATA/hcm_regenie_pheno.tsv ./')
system('gsutil cp gs://fc-secure-7953e92c-a6a6-42df-9f19-86d553a9044f/PP/DATA/hcm_regenie_cov.tsv ./')

regenie_hcm <- read_tsv('hcm_regenie_pheno.tsv')
regenie_cov2 <- read_tsv('hcm_regenie_cov.tsv')
...
#Reupload
system('gsutil cp DATA/hcm_regenie_pheno_euronly.tsv gs://fc-secure-7953e92c-a6a6-42df-9f19-86d553a9044f/PP/DATA/')
system('gsutil cp DATA/hcm_regenie_cov_euronly.tsv gs://fc-secure-7953e92c-a6a6-42df-9f19-86d553a9044f/PP/DATA/')
```
...
system('gsutil -m cp -r ./euronly/ gs://fc-secure-7953e92c-a6a6-42df-9f19-86d553a9044f/PP/DATA/MatchIt/' )
```
...
age_sexmatched_filewriter <- function(index_choice, input_list, regenie_pheno, regenie_covar, output_suffix){
  ...
  system(str_c('gsutil cp', output_phenoname, output_covname, 'gs://fc-secure-7953e92c-a6a6-42df-9f19-86d553a9044f/PP/DATA/', sep =' '))
