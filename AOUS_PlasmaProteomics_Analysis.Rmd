...
biomarker_cleaner <- function(input_tb, biomarker_of_interest, colname_of_interest, upper_limit){
  ...
  filtered_tb <- filtered_tb %>%
    filter(str_detect(unit_concept_name, 'per|/|liter'), !str_detect(unit_concept_name, 'unit|u/L|percent|thousand')) #Remove activity measures
